...
export const powershellGrammar: Grammar = {
  ...
  keywords: {
    if: 'keyword.control.powershell',
    else: 'keyword.control.powershell',
    elseif: 'keyword.control.powershell',
    switch: 'keyword.control.powershell',
    for: 'keyword.control.powershell',
    foreach: 'keyword.control.powershell',
    while: 'keyword.control.powershell',
    do: 'keyword.control.powershell',
    until: 'keyword.control.powershell',
    break: 'keyword.control.powershell',
    continue: 'keyword.control.powershell',
    return: 'keyword.control.powershell',
    function: 'storage.type.powershell',
    ...
    $true: 'constant.language.powershell',
    $false: 'constant.language.powershell',
