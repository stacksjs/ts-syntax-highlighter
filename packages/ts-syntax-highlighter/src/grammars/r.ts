...
export const rGrammar: Grammar = {
  ...
  scopeName: 'source.r',
  keywords: {
    'if': 'keyword.control.r', 'else': 'keyword.control.r', 'for': 'keyword.control.r', 'while': 'keyword.control.r',
    'repeat': 'keyword.control.r', 'break': 'keyword.control.r', 'next': 'keyword.control.r', 'return': 'keyword.control.r',
    'function': 'storage.type.r', 'in': 'keyword.operator.r', 'TRUE': 'constant.language.r', 'FALSE': 'constant.language.r',
    'NULL': 'constant.language.r', 'NA': 'constant.language.r', 'NaN': 'constant.language.r', 'Inf': 'constant.language.r',
  },
