...
export const luaGrammar: Grammar = {
  ...
  keywords: {
    and: 'keyword.operator.lua',
    break: 'keyword.control.lua',
    do: 'keyword.control.lua',
    else: 'keyword.control.lua',
    elseif: 'keyword.control.lua',
    end: 'keyword.control.lua',
    false: 'constant.language.lua',
    for: 'keyword.control.lua',
    function: 'keyword.control.lua',
    if: 'keyword.control.lua',
    in: 'keyword.control.lua',
    local: 'storage.modifier.lua',
    nil: 'constant.language.lua',
    not: 'keyword.operator.lua',
    or: 'keyword.operator.lua',
    repeat: 'keyword.control.lua',
    return: 'keyword.control.lua',
    then: 'keyword.control.lua',
    true: 'constant.language.lua',
    until: 'keyword.control.lua',
