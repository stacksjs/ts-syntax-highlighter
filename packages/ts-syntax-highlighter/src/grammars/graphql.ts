...
export const graphqlGrammar: Grammar = {
  ...
  keywords: {
    'query': 'keyword.operation.graphql', 'mutation': 'keyword.operation.graphql', 'subscription': 'keyword.operation.graphql',
    'fragment': 'keyword.operation.graphql', 'type': 'keyword.type.graphql', 'interface': 'keyword.type.graphql',
    'union': 'keyword.type.graphql', 'enum': 'keyword.type.graphql', 'input': 'keyword.type.graphql',
    'scalar': 'keyword.type.graphql', 'schema': 'keyword.type.graphql', 'extend': 'keyword.type.graphql',
    'implements': 'keyword.type.graphql', 'on': 'keyword.other.graphql',
    'true': 'constant.language.graphql', 'false': 'constant.language.graphql', 'null': 'constant.language.graphql',
  },
