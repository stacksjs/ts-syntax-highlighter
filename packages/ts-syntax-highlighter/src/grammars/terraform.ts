...
export const terraformGrammar: Grammar = {
  ...
  keywords: {
    'resource': 'keyword.other.terraform', 'data': 'keyword.other.terraform', 'variable': 'keyword.other.terraform',
    'output': 'keyword.other.terraform', 'locals': 'keyword.other.terraform', 'module': 'keyword.other.terraform',
    'provider': 'keyword.other.terraform', 'terraform': 'keyword.other.terraform', 'for': 'keyword.control.terraform',
    'if': 'keyword.control.terraform', 'else': 'keyword.control.terraform', 'in': 'keyword.control.terraform',
    'true': 'constant.language.terraform', 'false': 'constant.language.terraform', 'null': 'constant.language.terraform',
  },
