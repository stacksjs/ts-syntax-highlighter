...
export const protobufGrammar: Grammar = {
  ...
  keywords: {
    'syntax': 'keyword.other.proto', 'package': 'keyword.other.proto', 'import': 'keyword.other.proto', 'option': 'keyword.other.proto',
    'message': 'keyword.other.proto', 'enum': 'keyword.other.proto', 'service': 'keyword.other.proto', 'rpc': 'keyword.other.proto',
    'returns': 'keyword.other.proto', 'repeated': 'storage.modifier.proto', 'optional': 'storage.modifier.proto',
    'required': 'storage.modifier.proto', 'true': 'constant.language.proto', 'false': 'constant.language.proto',
  },
